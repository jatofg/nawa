...
#ifndef SORU_BCRYPTHASHINGENGINE_H
#define SORU_BCRYPTHASHINGENGINE_H
...
namespace soru {
    namespace Engines {
         ...
         * through the corresponding Qsf::Crypto functions for password hashing.
         */
...
#endif //SORU_BCRYPTHASHINGENGINE_H
