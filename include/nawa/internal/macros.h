...
#define NAWA_COPY_ASSIGNMENT_OPERATOR_DERIVED_IMPL(Class, Parent) Class &Class::operator=(const Class &other) { if (this != &other) { Parent::operator=(other); *data = *other.data; } return *this; }
#define NAWA_COPY_ASSIGNMENT_OPERATOR_DERIVED_IMPL_WITH_NS(Namespace, Class, Parent) Namespace::Class &Namespace::Class::operator=(const Namespace::Class &other) { if (this != &other) { Parent::operator=(other); *data = *other.data; } return *this; }
...
#define NAWA_MOVE_CONSTRUCTOR_DERIVED_IMPL(Class, Parent) Class::Class(Class &&other) noexcept: Parent(move(other)), data(move(other.data)) {}
#define NAWA_MOVE_CONSTRUCTOR_DERIVED_IMPL_WITH_NS(Namespace, Class, Parent) Namespace::Class::Class(Namespace::Class &&other) noexcept: Parent(move(other)), data(move(other.data)) {}
